...
if __name__ == "__main__":
    import ssl
    import os
    # Chemin absolu vers le dossier contenant les certificats
    certs_dir = os.path.join(os.path.dirname(__file__), 'membre2-alerts')
    cert_path = os.path.join(certs_dir, 'localhost+1.pem')
    key_path = os.path.join(certs_dir, 'localhost+1-key.pem')
